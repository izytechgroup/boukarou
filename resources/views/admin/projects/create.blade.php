                    ...
                    <div class="col-sm-8">
                        <div class="block">
                            <div class="block-content">
                                ...
                                <div class="mt-20">
                                    <label>Dévelopement de l'idée</label>
                                    <textarea name="development_idee" class="tiny"></textarea>
                                </div>

                                <div class="mt-20">
                                    <label>Dévelopement du projet</label>
                                    <textarea name="development_projet" class="tiny"></textarea>
                                </div>

                                <div class="form-group mt-20">
                                    <label>Nom du porteur</label>
                                    <input type="text" name="porteur" value="{{ old('porteur') }}"
                                ...
                                <div class="form-group">
                                    <label>Contact</label>
                                    <input type="text" name="porteur" value="{{ old('contact') }}"
                                        placeholder="Contact"
                                        class="form-control input-lg">
                                </div>
                            </div>
